...
rFilePath <- paste(directory, rFile, sep = "")
beginnerFilePath <- paste(directory, beginnerFile, sep = "")
intermediateFilePath <- paste(directory, intermediateFile, sep = "")
advancedFilePath <- paste(directory, advancedFile, sep = "")
